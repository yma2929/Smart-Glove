...
function setupEventListeners() {
    ...
    const modalBtn = document.getElementById('viewDetailsBtn');
    if (modalBtn) {
        modalBtn.onclick = () => document.getElementById('detailsModal').style.display = 'block';
    }
...
document.getElementById('addNoteTrigger').addEventListener('click', () => {
...
document.getElementById('viewDetailsBtn').onclick = () => {
    ...
    renderRadarChart(); // Initialize Overview
};
...
function setupEventListeners() {
    ...
    // Modal Close Logic
    const closeBtn = document.getElementById('closeModal');
    const closeBtnAlt = document.getElementById('closeModalBtn');
